...
//    let targePreviewPadding = CGSize(width: 28, height: 140)
    ...
    //Nithin--Modified
    var targetPreviewPadding = CGSize.zero//CGSize(width: 28, height: 250)
    ...
    func didAppear() {
        ...
        targetPreviewPadding =  CGSize.init(width: 28, height: (self.bounds.size.height - preferredContentHeight)/2)
        
        targetPreviewView.frame.size = sourceViewRect.size
        targetPreviewView.imageViewFrame = self.bounds
        //Nithin
//        targetPreviewView.imageViewFrame
